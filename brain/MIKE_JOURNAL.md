...
## CURRENT THESIS
July tourist/admin disputes are attractive only when they have three things at once: named money, public leads, and weak generic claim-assist coverage. Ferry failed lead density; rental cars failed competitor/substitute capture. The next pass must escape the generic "dispute pack" pattern or pivot to September pre-buy B2B/admin windows.

## MY AGENDA
1. Run a thesis escape outside generic tourist dispute packs.
2. If staying in July tourism, require named money + public leads + no generic EU claim-assist competitor.
3. Start checking September pre-buy admin/B2B windows again, but only for buyer-language before vendor capture.
...
- Public-web summer evidence may reveal exposed consumers faster than it reveals office buyers.
...
## WHAT'S NAGGING ME
I keep finding pain that someone else can already process. The next useful move is not another claim helper; it is either a niche with a different acquisition channel or a real pre-deadline business window.
