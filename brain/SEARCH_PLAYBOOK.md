...
- 2026-06-27: For AADE workflow ideas, run the sector-roadmap query and the exact product query (`app`, official FAQ, vendor automation) together; if the app and automation layer appear immediately, broader scope should raise market size but lower Competition Gap.
