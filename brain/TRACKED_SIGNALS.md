# Tracked Signals
*Active signals being monitored. Format: Signal | Status | Direction | Last Checked | Notes*
...
| e-invoicing setup/referral window | ACTIVE | down | 2026-09-04 | The post-choice setup/referral possibility remains alive only through accountants/providers or declaration-audit overflow. Current red-error/MARK/omission/discrepancy snippets prove operational mess, but Pegasus/Epsilon/Entersoft docs, AADE support and accountant rails still own the triage before direct buyer pull appears. |
...
| Hotel staff accommodation / onboarding wedge | ACTIVE | down | 2026-07-03 | INSETE frames staff accommodation as a structural lodging issue, while live 2026 hotel jobs already bundle housing, food and training, so post-hiring pain looks employer-internal rather than founder-open |
...
| Ferry passenger-claim friction | ACTIVE | down | 2026-08-24 | The pain and rules still exist, but current August coverage again routes passengers straight to the ferry company, ticket issuer or port agent for refund/compensation. Without direct conversion proof, the founder wedge is weaker than the official rail. |
| Ferry claim-pack competition | ACTIVE | down | 2026-08-24 | FairFerry still exists and the late-August pass did not improve the public lead surface. Competition plus direct official/company complaint paths keep the generic claim-pack lane capped. |
...
| Student housing parent search pressure | ACTIVE | up | 2026-08-24 | Late-August pressure is clearly higher: fresh 2026 coverage points to rent spikes, scams and parent guidance after the rush started. But the founder wedge is still weak because the visible surface remains guides, listings and owner advice rather than paid judgement demand. |
| Mutual student transfer matching | ACTIVE | down | 2026-08-24 | August 2026 snippets show real student attention around reciprocal transfers, but the matching layer is already visible: Foititika Nea's platform shows 253 active ads and PaideiaNet/social pages explain the search path. This is not a clean new matching wedge. |
| Back-to-school study / parallel-support demand | ACTIVE | down | 2026-09-04 | The sharper September read is parallel support rather than generic tutoring: public asks show roughly EUR7/hour and EUR900-EUR1000/month, plus broad approval volume. But the channel is still Nannuka, Jooble and Facebook-group hiring, which makes this a trusted matching rail rather than a founder-open service lane. |
| September education/childcare matching | ACTIVE | down | 2026-09-04 | New September snippets reinforce the same pattern: Nannuka shows hundreds of babysitting ads and EUR15/hour examples, Jooble/Indeed aggregate urgent roles, Studyzy gathers student tutoring requests, and Paramana covers babysitting in Thessaloniki. Demand is real, but matching is owned. |
| September small-school enrollment/admin hiring | ACTIVE | down | 2026-09-04 | Dance schools, language centers and tutoring centers show September secretary/admin demand around afternoon enrollment, phones, parent communication and schedules, but Jooble/Indeed/Jobfind/Careerjet/Facebook hiring rails and tele-secretary/VA surfaces appear before outsourced-overflow buyer language. |
| Elder-care coverage and repos demand | ACTIVE | down | 2026-09-04 | Nannuka/Jooble snippets show serious paid demand around EUR8/hour and EUR1000-EUR1400/month, including one-month October coverage and repos/relief cases. But Nannuka and Jooble already own the trust/hiring surface with hundreds of ads and available caregivers, so this is another brokered-care market unless a private bench exists. |
| School-list / used-book savings pressure | ACTIVE | down | 2026-08-24 | Back-to-school cost pressure is real, but the response layer is already broad: Vendora shows thousands of used school-book/help-book listings, Facebook/book groups exist, and shops/list services already offer "send the school list" convenience. |
| Student move-in logistics | ACTIVE | down | 2026-08-24 | Student moving is real and priceable, with EUR70-EUR220 small student moves and EUR120-EUR400 wider private moves in snippets, but Haulx, Douleutaras and mover quote pages already own the response path. |
| Discount-season small retail pressure | ACTIVE | up | 2026-09-04 | Early-September 2026 reinforcement says Black Friday falls on 27 Nov and now stretches across much of November, while BestPrice aggregates 3,700+ e-shops and BusinessDaily/Forbes frame success as data, e-shop and platform readiness that larger players already own. Pressure is real, but the founder-open rescue lane is still weak because shopper discovery and prep are comparison-engine, marketplace and infrastructure-led. |
...
| Low-cost flight admin micro-friction | ACTIVE | down | 2026-07-03 | Boarding-pass/check-in confusion is real, but Ryanair's digital-pass shift and Volotea's app plus paid airport-check-in rail mean the workaround is increasingly airline-owned rather than founder-open |
...
| STR same-day turnover pressure | ACTIVE | down | 2026-07-03 | Hosts ask for cleaners and urgent turnover is real, but cleaning operators already sell last-minute SOS, same-day turnover, calendar integration, linen/laundry and damage-report workflows |
| Airbnb key/access emergency pressure | ACTIVE | down | 2026-07-03 | Lockbox/key failure pain is real, but locksmiths and smart-lock vendors already own emergency access and prevention |
...
| Social-tourism accommodation availability friction | ACTIVE | down | 2026-08-24 | The DYPA 2026-2027 program remains large and live, but the visible late-August surface still pairs unanswered calls/availability pain with free request-list tools rather than paid delegation language. The pain persists; the founder wedge still does not clear the pay gate. |
| Greek export/exhibition September activity | ACTIVE | down | 2026-09-04 | Enterprise Greece/BusinessDaily snippets show Greek firms joining 16 international exhibitions in September 2026, and the sharper post-choice search surfaced expo-lead follow-up pain and agency education. Public snippets named 16 concrete target examples around SMM and Automechanika, but Reco Exports, Orbit, Expolista and ASAP show follow-up/contact/list/logistics capture. Without direct replies, Post-Expo Lead Rescue is killed; the signal stays only as a future outreach-revival lane. |
...
| Parent-voucher / childcare application rush | ACTIVE | up | 2026-07-03 | EETAA/KDAP 2026-2027 applications and up-to-EUR500/month support are surfacing, but the public surface is center/application info rather than explicit paid-help demand |
| Home-upgrade subsidy document workflow | ACTIVE | down | 2026-07-03 | Anavathmizo/Exoikonomo/Spiti Mou follow-on searches surfaced gov, bank, engineer and technical-advisor rails plus dated/closed windows, so a solo document concierge looks institutionally owned |
...
| Google Maps / local profile cleanup | ACTIVE | down | 2026-08-24 | The before-state is visible and specific: wrong hours, old photos, missing services and unanswered reviews. But agencies already sell the exact Google Business Profile/Maps cleanup, including fixed 48h-style positioning, so this is an outreach tactic, not a standalone idea yet. |
| Online-earner specialist-accountant discovery | ACTIVE | down | 2026-08-24 | Buyer pain is still real, but the adversarial pass surfaced direct specialist rails quickly: current ETF tax explainers and advisory pages from KSTLaw, Tax Experts and Tsaks are easy to find before any pay-intent for a routing-only middleman. Without verified bench proof or buyer conversion, the wedge weakens. |
...
| ESPA funding calls | ACTIVE | stable | 2026-07-03 | Fresh July programming/open-call snippets still skew to institutional, regional, employment and sector-specific digital-service calls rather than a broad solo-founder wedge |
