...
| e-invoicing setup/referral window | ACTIVE | down | 2026-09-04 | The post-choice setup/referral possibility remains alive only through accountants/providers or declaration-audit overflow. AFS, MDC and similar pages now explain the mandate, transition and tool path so clearly that owner-layer capture strengthened again versus any DTC founder pull. |
