...
*Last updated: 2026-07-03 | Pool size: 3 probation ideas | Avg score: 6.4*

---

## #1: Social Tourism Availability Caller - 6.4 - PROBATION
**Simple version:** Call hotels/rooms for social-tourism voucher holders and return only confirmed available options.
...
## #2: Student Housing Parent Shortlist - 6.4 - PROBATION
**Simple version:** Make a safe, route-aware, scam-screened housing shortlist for parents before the September student rush.
...
## #3: Ferry Passenger Claim Pack - 6.4 - PROBATION
**Simple version:** Help ferry passengers prepare delay/refund/lost-luggage claims in Greek/English.
